...
public class HistoryAccountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private List<AccountBean> accountBeans;
    private List<AccountBean> accountBeansIn;
    private static final int TYPE_HEADER = 1;
    private static final int TYPE_HEADER_IN = 100001;
    private static final int TYPE_IN = 111111111;
    ...
    public HistoryAccountAdapter(Context context, List<AccountBean> accountBeans, boolean isShow) {
...
/*        // 设置长按监听
    ...
    public int getItemViewType(int position) {
        ...
        if (position==0){
            return TYPE_HEADER;
        }else if(position<=accountBeans.size()){
            return super.getItemViewType(position);
        }else if (position==accountBeans.size()+1){
            return TYPE_HEADER_IN;
        }else {
            return super.getItemViewType(position);
        }
